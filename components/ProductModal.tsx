                ...
                >
                    ...
                    <div className="p-6 overflow-y-auto hide-scrollbar flex-grow bg-white">
                        ...
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-gray-800">Catatan Tambahan (Opsional)</label>
                            <textarea
                                rows={3} placeholder="Contoh: Pisah sambal, tambah kuah..." value={notes} onChange={(e) => setNotes(e.target.value)}
